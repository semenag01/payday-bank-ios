...
public extension SMDBStorableObject {
    ...
    static var defaultStorage: SMDBStorage {
        return SMDBStorageConfigurator.storage
    }
    ...
    static func allObjectsNSFetchRequest() -> NSFetchRequest<Self> {

        let request: NSFetchRequest = NSFetchRequest<Self>(entityName: _entityName)
